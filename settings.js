...
var daohang_data = [
    ...
    {
        id:'ctl00_aboutLi', /*id，随便起名字就行，*/
        name:'关于恒川海',
        html:'#', /*#表示用户点击“关于恒川海”菜单时没有任何响应*/
        items:[
            {
                img:{
                ...
                html:'#', /*会word的办公室文员们，可以利用word，编辑文档，生成html，word有很强大的图文编辑功能额*/
                name:'主席致辞'/*这里是菜单名称，注意额，每个大括号}前面都没有逗号，额！*/
            },
            {
                img:{
                    topimg:'home/assets/images/topimg2.png', /*最上部的图片*/
                    titleimg:'assets/images/title.png', /*上面导航 条上的图片*/
                    leftimg:'assets/images/leftimg.png', /*左侧导航栏上部的图片*/
...
var shouye_data = {
    logo:'assets/images/logo.png', /*logo配置位置*/
    flash:[
        {/*首页大图配置*/
            name:'', /*标题，不会显示到页面上，不配置也可以*/
    ...
    imTop:{/*倒数第二行图片和链接配置*/
        left:{
            name:'麦岛家园', /*标题，将会显示在图片上面，此标题可以与gotoo属性一致*/
            img:'assets/images/top_03.jpg', /*自定义图片*/
    ...
    fdgg:{/*暂时支持一个图片广告*/
        gotoo:'', /*指定daohang_data中的某一个name属性的值*/
        download:'', /*用户点击广告图片后，下载的文件的相对路径*/
        img:'assets/images/20130503010101.jpg' /*图片路径*/

    },
    footer:{/*页面最下面部分配置*/
        banquan:'恒川海投资有限公司', /*版权所有者*/
        qita:[
            {
                name:'法律声明',
                gotoo:'法律声明'
